...
`PUT https://localhost:81/User/{UserId}/Roles`
...
Name | Parameter Type | Data Type | Required | Description
----- | -------------- | --------- | -------- | -----------
RoleList | body | List | true | A list of roles to assign to the user.
...
- `ERROR_RECORD_NOT_FOUND`: The user or one or more roles in the role list do not exist.
